					...
					<div className='card border shadow-0 ' style={{ borderRadius: "0", backgroundColor:mycardcolor }} >
						<div className='card-body ps-5 pe-5 pt-4 '>
							...
							<div className='col-md-7 mx-auto text-center'>
								...
								<button className='btn btn-primary form-control fs-' style={{fontSize:'15px'}}>7390973268</button>
							</div>
							<div className='mt-5'>
								<div className='row'>
								<div className='col'>
								...
								<div className='heightlen'>
									<p>Apt-19 near Laleshwar Mandir</p>
									<p>Narpat kera, Para</p>
									<p>Lucknow 226017</p>
								</div>
							</div>
							<div>
